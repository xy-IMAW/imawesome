...
namespace Maticsoft.DAL
{
	...
	public partial class newsDAL
	{
		...
		public bool Exists(int news_id)
		{
			...
			strSql.Append(" where news_id=SQL2012news_id");
			SqlParameter[] parameters = {
					new SqlParameter("SQL2012news_id", SqlDbType.Int,4)
			};
		...
		public int Add(Maticsoft.Model.news model)
		{
			...
			strSql.Append("SQL2012news_createtime,SQL2012news_posterid,SQL2012news_title,SQL2012news_class,SQL2012news_abstract,SQL2012news_content,SQL2012news_readnum,SQL2012news_state)");
			strSql.Append(";select @@IDENTITY");
			SqlParameter[] parameters = {
					new SqlParameter("SQL2012news_createtime", SqlDbType.DateTime),
					new SqlParameter("SQL2012news_posterid", SqlDbType.VarChar,50),
					new SqlParameter("SQL2012news_title", SqlDbType.NVarChar,50),
					new SqlParameter("SQL2012news_class", SqlDbType.NVarChar,50),
					new SqlParameter("SQL2012news_abstract", SqlDbType.NVarChar,200),
					new SqlParameter("SQL2012news_content", SqlDbType.NVarChar,-1),
					new SqlParameter("SQL2012news_readnum", SqlDbType.Int,4),
					new SqlParameter("SQL2012news_state", SqlDbType.Int,4)};
		...
		public bool Update(Maticsoft.Model.news model)
		{
			...
			strSql.Append("news_createtime=SQL2012news_createtime,");
			strSql.Append("news_posterid=SQL2012news_posterid,");
			strSql.Append("news_title=SQL2012news_title,");
			strSql.Append("news_class=SQL2012news_class,");
			strSql.Append("news_abstract=SQL2012news_abstract,");
			strSql.Append("news_content=SQL2012news_content,");
			strSql.Append("news_readnum=SQL2012news_readnum,");
			strSql.Append("news_state=SQL2012news_state");
			strSql.Append(" where news_id=SQL2012news_id");
			SqlParameter[] parameters = {
					new SqlParameter("SQL2012news_createtime", SqlDbType.DateTime),
					new SqlParameter("SQL2012news_posterid", SqlDbType.VarChar,50),
