<%@ Page Title="apply_member" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Maticsoft.Web.apply_member.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="applydate" HeaderText="applydate" SortExpression="applydate" ItemStyle-HorizontalAlign="Center"  /> 
