...
namespace Maticsoft.BLL
{
	...
	{
		private readonly Maticsoft.DAL.bannerDAL dal=new Maticsoft.DAL.bannerDAL();
		public bannerBLL()
		{}
		#region  BasicMethod
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Maticsoft.Model.banner GetModelByCache(int banner_id)
		{
			...
			return (Maticsoft.Model.banner)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Maticsoft.Model.banner> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Maticsoft.Model.banner> DataTableToList(DataTable dt)
		{
			List<Maticsoft.Model.banner> modelList = new List<Maticsoft.Model.banner>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Maticsoft.Model.banner model;
