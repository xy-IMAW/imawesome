<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="newsadd.aspx.cs" Inherits="imaw.Admin.newsadd" %>
    ...
    <form id="form1" runat="server">
        ...
        <f:Form ID="SimpleForm1" ShowBorder="false" ShowHeader="false"
            ...
            <Rows>
                <f:FormRow>
                    <Items>
                        ...
                        <f:DropDownList runat="server" ID="news_state" AutoSelectFirstItem="false" AutoPostBack="false" Label="新闻类别">
                            <f:ListItem Text="头条新闻" Value="1" Selected="True" />
                ...
                <f:FormRow>
                    <Items>
                        <f:TextBox runat="server" ID="news_title" Label="新闻标题"  AutoPostBack="true" ></f:TextBox>
