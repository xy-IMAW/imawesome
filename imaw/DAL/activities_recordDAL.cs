...
namespace IMAW.DAL
{
	...
	public partial class activities_recordDAL
	{
		...
		public bool Exists(string act_sn)
		{
			...
			strSql.Append(" where act_sn=@act_sn ");
			SqlParameter[] parameters = {
					new SqlParameter("@act_sn", SqlDbType.VarChar,20)			};
		...
		/// 增加一条数据
		/// </summary>
		public bool Add(IMAW.Model.activities_record model)
		{
			StringBuilder strSql=new StringBuilder();
			...
			SqlParameter[] parameters = {
					new SqlParameter("@act_sn", SqlDbType.VarChar,20),
					new SqlParameter("@act_appleytime", SqlDbType.DateTime),
					new SqlParameter("@act_id", SqlDbType.Char,8),
					new SqlParameter("@member_id", SqlDbType.Char,13),
					new SqlParameter("@state", SqlDbType.NVarChar,8),
					new SqlParameter("@checker_id", SqlDbType.Char,2),
					new SqlParameter("@checker_date", SqlDbType.NVarChar,20),
					new SqlParameter("@member_evaluate", SqlDbType.Char,200),
					new SqlParameter("@reply_id", SqlDbType.Char,10),
					new SqlParameter("@reply_date", SqlDbType.DateTime)};
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(IMAW.Model.activities_record model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update activities_record set ");
			strSql.Append("act_appleytime=@act_appleytime,");
			strSql.Append("act_id=@act_id,");
			strSql.Append("member_id=@member_id,");
			strSql.Append("state=@state,");
			strSql.Append("checker_id=@checker_id,");
			strSql.Append("checker_date=@checker_date,");
			strSql.Append("member_evaluate=@member_evaluate,");
			strSql.Append("reply_id=@reply_id,");
			strSql.Append("reply_date=@reply_date");
			strSql.Append(" where act_sn=@act_sn ");
			SqlParameter[] parameters = {
					new SqlParameter("@act_appleytime", SqlDbType.DateTime),
					new SqlParameter("@act_id", SqlDbType.Char,8),
		...
		/// 得到一个对象实体
		/// </summary>
		public IMAW.Model.activities_record GetModel(string act_sn)
		{
			...
			IMAW.Model.activities_record model=new IMAW.Model.activities_record();
		...
		/// 得到一个对象实体
		/// </summary>
		public IMAW.Model.activities_record DataRowToModel(DataRow row)
		{
			IMAW.Model.activities_record model=new IMAW.Model.activities_record();
			if (row != null)
			{
