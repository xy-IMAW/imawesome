...
namespace IMAW.DAL
{
	...
	public partial class notice_emailDAL
	{
		...
		public bool Exists(string email_sn)
		{
			...
			strSql.Append(" where email_sn=@email_sn ");
			SqlParameter[] parameters = {
					new SqlParameter("@email_sn", SqlDbType.VarChar,20)			};
		...
		public bool Add(IMAW.Model.notice_email model)
		{
			...
			SqlParameter[] parameters = {
					new SqlParameter("@email_sn", SqlDbType.VarChar,20),
					new SqlParameter("@email_class", SqlDbType.NVarChar,50),
					new SqlParameter("@email_theme", SqlDbType.Bit,1),
					new SqlParameter("@email_content", SqlDbType.DateTime),
					new SqlParameter("@email_doc_id", SqlDbType.VarChar,50),
					new SqlParameter("@email_postitme", SqlDbType.DateTime),
					new SqlParameter("@email_settime", SqlDbType.DateTime),
					new SqlParameter("@sender_id", SqlDbType.VarChar,20)};
		...
		public bool Update(IMAW.Model.notice_email model)
		{
			...
			strSql.Append("email_class=@email_class,");
			strSql.Append("email_theme=@email_theme,");
			strSql.Append("email_content=@email_content,");
			strSql.Append("email_doc_id=@email_doc_id,");
			strSql.Append("email_postitme=@email_postitme,");
			strSql.Append("email_settime=@email_settime,");
		...
		public IMAW.Model.notice_email GetModel(string email_sn)
		{
			...
			IMAW.Model.notice_email model=new IMAW.Model.notice_email();
		...
		/// 得到一个对象实体
		/// </summary>
		public IMAW.Model.notice_email DataRowToModel(DataRow row)
		{
			IMAW.Model.notice_email model=new IMAW.Model.notice_email();
			if (row != null)
			{
