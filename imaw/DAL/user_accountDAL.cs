...
namespace IMAW.DAL
{
	...
	public partial class user_accountDAL
	{
		...
		/// 增加一条数据
		/// </summary>
		public bool Add(IMAW.Model.user_account model)
		{
			StringBuilder strSql=new StringBuilder();
			...
			SqlParameter[] parameters = {
					new SqlParameter("@user_id", SqlDbType.VarChar,50),
					new SqlParameter("@user_pwd", SqlDbType.VarChar,20),
					new SqlParameter("@user_nickname", SqlDbType.NVarChar,50),
					new SqlParameter("@user_registerdate", SqlDbType.DateTime),
					new SqlParameter("@user_lastlogindate", SqlDbType.DateTime),
					new SqlParameter("@user_loginnum", SqlDbType.Int,4),
					new SqlParameter("@user_email", SqlDbType.VarChar,50),
					new SqlParameter("@user_photo", SqlDbType.VarChar,50),
					new SqlParameter("@user_pwd_que", SqlDbType.NVarChar,50),
					new SqlParameter("@user_pwd_ans", SqlDbType.NVarChar,50),
					new SqlParameter("@user_class", SqlDbType.Int,4)};
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(IMAW.Model.user_account model)
		{
			StringBuilder strSql=new StringBuilder();
			...
			strSql.Append("user_lastlogindate=@user_lastlogindate,");
			strSql.Append("user_loginnum=@user_loginnum,");
			strSql.Append("user_email=@user_email,");
			strSql.Append("user_photo=@user_photo,");
			strSql.Append("user_pwd_que=@user_pwd_que,");
			strSql.Append("user_pwd_ans=@user_pwd_ans,");
			strSql.Append("user_class=@user_class");
			strSql.Append(" where user_id=@user_id ");
			SqlParameter[] parameters = {
					new SqlParameter("@user_pwd", SqlDbType.VarChar,20),
					new SqlParameter("@user_nickname", SqlDbType.NVarChar,50),
		...
		/// 得到一个对象实体
		/// </summary>
		public IMAW.Model.user_account GetModel(string user_id)
		{
			...
			IMAW.Model.user_account model=new IMAW.Model.user_account();
		...
		/// 得到一个对象实体
		/// </summary>
		public IMAW.Model.user_account DataRowToModel(DataRow row)
		{
			IMAW.Model.user_account model=new IMAW.Model.user_account();
			if (row != null)
			{
