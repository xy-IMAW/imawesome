...
namespace IMAW.DAL
{
	...
	public partial class user_infoDAL
	{
		...
		/// 增加一条数据
		/// </summary>
		public bool Add(IMAW.Model.user_info model)
		{
			StringBuilder strSql=new StringBuilder();
			...
			SqlParameter[] parameters = {
					...
					new SqlParameter("@user_stuid", SqlDbType.VarChar,50),
					new SqlParameter("@user_school", SqlDbType.NVarChar,50),
					new SqlParameter("@user_major", SqlDbType.NVarChar,50),
					new SqlParameter("@user_sex", SqlDbType.NChar,2),
					new SqlParameter("@user_phone", SqlDbType.VarChar,20),
					new SqlParameter("@user_email", SqlDbType.VarChar,50),
					new SqlParameter("@user_qq", SqlDbType.VarChar,50),
					new SqlParameter("@user_birthday", SqlDbType.Date,3),
					new SqlParameter("@user_home", SqlDbType.NVarChar,20),
					new SqlParameter("@user_nation", SqlDbType.NVarChar,50),
					new SqlParameter("@user_politices", SqlDbType.NVarChar,50)};
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(IMAW.Model.user_info model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update user_info set ");
			strSql.Append("user_realname=@user_realname,");
			strSql.Append("user_stuid=@user_stuid,");
			...
			strSql.Append("user_home=@user_home,");
			strSql.Append("user_nation=@user_nation,");
			strSql.Append("user_politices=@user_politices");
			strSql.Append(" where user_id=@user_id ");
			SqlParameter[] parameters = {
					new SqlParameter("@user_realname", SqlDbType.NVarChar,50),
					new SqlParameter("@user_stuid", SqlDbType.VarChar,50),
		...
		/// 得到一个对象实体
		/// </summary>
		public IMAW.Model.user_info GetModel(string user_id)
		{
			...
			IMAW.Model.user_info model=new IMAW.Model.user_info();
		...
		/// 得到一个对象实体
		/// </summary>
		public IMAW.Model.user_info DataRowToModel(DataRow row)
		{
			IMAW.Model.user_info model=new IMAW.Model.user_info();
			if (row != null)
			{
