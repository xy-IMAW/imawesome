	...
	public partial class dept_roleDAL
	{
		...
		public bool Add(IMAW.Model.dept_role model)
		{
			...
			SqlParameter[] parameters = {
					...
					new SqlParameter("@role_introduce", SqlDbType.NVarChar,300)};
		...
		public bool Update(IMAW.Model.dept_role model)
		{
			...
			strSql.Append("role_introduce=@role_introduce");
			strSql.Append(" where role_id=@role_id ");
			SqlParameter[] parameters = {
					new SqlParameter("@dept_id", SqlDbType.Int,4),
					new SqlParameter("@role_introduce", SqlDbType.NVarChar,300),
		...
		public IMAW.Model.dept_role GetModel(int role_id)
		{
			...
			IMAW.Model.dept_role model=new IMAW.Model.dept_role();
		...
		/// 得到一个对象实体
		/// </summary>
		public IMAW.Model.dept_role DataRowToModel(DataRow row)
		{
			IMAW.Model.dept_role model=new IMAW.Model.dept_role();
			if (row != null)
			{
