...
namespace IMAW.BLL
{
	...
	{
		private readonly IMAW.DAL.user_infoDAL dal=new IMAW.DAL.user_infoDAL();
		public user_infoBLL()
		{}
		#region  BasicMethod
		/// <summary>
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		//public IMAW.Model.user_info GetModelByCache(string user_id)
		//{
		...
		//		catch{}
		//	}
		//	return (IMAW.Model.user_info)objModel;
		//}
		...
		/// 获得数据列表
		/// </summary>
		public List<IMAW.Model.user_info> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<IMAW.Model.user_info> DataTableToList(DataTable dt)
		{
			List<IMAW.Model.user_info> modelList = new List<IMAW.Model.user_info>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				IMAW.Model.user_info model;
