...
namespace IMAW.BLL
{
	...
	{
		private readonly Maticsoft.DAL.user_infoDAL dal=new Maticsoft.DAL.user_infoDAL();
		public user_infoBLL()
		{}
		#region  BasicMethod
		/// <summary>
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public Maticsoft.Model.user_info GetModelByCache(string user_id)
		{
			...
			return (Maticsoft.Model.user_info)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<Maticsoft.Model.user_info> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<Maticsoft.Model.user_info> DataTableToList(DataTable dt)
		{
			List<Maticsoft.Model.user_info> modelList = new List<Maticsoft.Model.user_info>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				Maticsoft.Model.user_info model;
